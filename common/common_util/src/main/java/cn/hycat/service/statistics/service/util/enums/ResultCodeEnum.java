package cn.hycat.service.statistics.service.util.enums;
...
public enum ResultCodeEnum {
    ...
    PARAMETER_EMPTY(false, 28008, "参数不能为空"),
    LOGIN_MOBLE_ERROR(false, 28009, "手机号尚未注册"),


    DONOT_YELLOW(false, 12345, "请不要搞黄色");
